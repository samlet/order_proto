...
@TableName("acctg_trans")
@ApiModel(value = "AcctgTransEntity对象", description = "")
public class AcctgTransEntity extends BaseEntity {

    private static final long serialVersionUID = 1L;

    @TableId(value = "acctg_trans_id", type = IdType.ASSIGN_ID)
